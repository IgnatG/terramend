# `lintel/get-installation-token`

Get a GitHub App installation token in a workflow job. This convenience action makes it easier to integrate Lintel into existing CI workflows.
...
- The Lintel GitHub App must be installed on the target repositories.
