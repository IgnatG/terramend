...
/**
 * Source written to `<ctx.tmpdir>/lintel-pretool-gate.mjs`. Plain ESM,
 ...
 */
export const CLAUDE_PRETOOL_GATE_FILENAME = "lintel-pretool-gate.mjs" as const;

export const CLAUDE_PRETOOL_GATE_SOURCE = `#!/usr/bin/env node
// AUTOGENERATED by Lintel. PreToolUse hook that hard-blocks state-mutating
...
process.stdin.on("end", () => {
  ...
  try {
    ...
    process.stderr.write("lintel-pretool-gate: malformed stdin JSON\\n");
    process.exit(1);
  }
 ...
 * matcher `^mcp__lintel__` is treated as a regex by claude-code's
 ...
 * start of the tool name and fires for every Lintel MCP tool. We narrow
